...
|---|---|---:|---:|---:|---:|
| Binary | HistGradientBoosting | 0.9965 | 0.9955 | 0.9155% | 124,464 B |
| Attack family | Random Forest | 0.9522 | 0.9873 | N/A | 532,967 B |
...
seed-42 cascade has macro-F1 0.9931 and 17 detector false negatives; its three-seed
mean macro-F1 is 0.9873.
